...
public class ClassificadoraIp{
	...
	public void mostrarDados() {
		...
		System.out.println("M�scara bin�ria: " + mascaraBinaria);
		System.out.println("M�scara decimal: " + mascaraDecimal);
		System.out.println("IPs por sub-rede com /" + cidr + ": " + getSubClasse() + " IPs dispon�veis");
